...
import { FeatureItem } from '../appClassic.style';
import ShapeOne from 'common/src/assets/image/appClassic/shape-1.svg';
import ShapeTwo from 'common/src/assets/image/appClassic/shape-2.svg';
import ShapeThree from 'common/src/assets/image/appClassic/shape-3.svg';
import ShapeFour from 'common/src/assets/image/appClassic/shape-4.svg';
import ShapeFive from 'common/src/assets/image/appClassic/shape-5.svg';
  ...
  return (
    <Box {...sectionWrapper}>
      <Container>
        ...
        <Box {...row}>
          {Data.appClassicJson.FEATURES_DATA.map((featureItem, index) => (
